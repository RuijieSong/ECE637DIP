...
int main (int argc, char **argv) 
{
  ...
  int32_t i,j,pixelg,pixelr,pixelb;
  ...
  /* Filter image with the IIR Filter */
  for ( i = 0; i < input_img.height; i++ )
  for ( j = 0; j < input_img.width; j++ ) {
    // img2[i][j] = (img1[i][j-1] + img1[i][j] + img1[i][j+1])/3.0;
    img2[i][j] = 0.01*img1[i][j];
    img3[i][j] = 0.01*imgr[i][j];
    img4[i][j] = 0.01*imgb[i][j];
    if (i>0) {
      img2[i][j] = img2[i][j] + 0.9*img2[i-1][j];
      img3[i][j] = img3[i][j] + 0.9*img3[i-1][j];
      img4[i][j] = img4[i][j] + 0.9*img4[i-1][j];
    }
    if (j>0) {
      img2[i][j] = img2[i][j] + 0.9*img2[i][j-1];
      img3[i][j] = img3[i][j] + 0.9*img3[i][j-1];
      img4[i][j] = img4[i][j] + 0.9*img4[i][j-1];
    }
    if (i>0 && j>0) {
      img2[i][j] = img2[i][j] - 0.81*img2[i-1][j-1];
      img3[i][j] = img3[i][j] - 0.81*img3[i-1][j-1];
      img4[i][j] = img4[i][j] - 0.81*img4[i-1][j-1];
    }
  }
