...
int main (int argc, char **argv) 
{
  ...
  /* Filter image with the F FIR Sharpening Filter */
  ...
  for ( j = 2; j < input_img.width-2; j++ ) {
    ...
    for ( jj = -2; jj <= 2; jj++ ) {
      if (ii == 0 && jj == 0) {
        img2[i][j] = img2[i][j] + (1+rho)*img1[i+ii][j+jj];
        img3[i][j] = img3[i][j] + (1+rho)*imgr[i+ii][j+jj];
        img4[i][j] = img4[i][j] + (1+rho)*imgb[i+ii][j+jj];
      }
      img2[i][j] = img2[i][j] - (rho*1/25)*img1[i+ii][j+jj];
      img3[i][j] = img3[i][j] - (rho*1/25)*imgr[i+ii][j+jj];
      img4[i][j] = img4[i][j] - (rho*1/25)*imgb[i+ii][j+jj];
    }
  }
  ...
  for ( j = input_img.width-2; j < input_img.width; j++ ) {
    for ( ii = -2; ii < input_img.height-i; ii++ )
    for ( jj = -2; jj < input_img.width-j; jj++ ) {
      if (ii == 0 && jj == 0) {
        img2[i][j] = img2[i][j] + (1+rho)*img1[i+ii][j+jj];
        img3[i][j] = img3[i][j] + (1+rho)*imgr[i+ii][j+jj];
        img4[i][j] = img4[i][j] + (1+rho)*imgb[i+ii][j+jj];
